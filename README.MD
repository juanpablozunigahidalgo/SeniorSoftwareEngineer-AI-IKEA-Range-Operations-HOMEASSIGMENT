...
> **Delivery Date:** Wednesday, December 17, 2025

---

## 📝 Overview
This repository contains a **RESTful API** designed to manage store inventory. It implements full product lifecycle management and enforces strict business rules for stock adjustments to ensure data integrity.
...
If you want to see the logic explained simple follow the link 
https://docs.google.com/presentation/d/10F90r_2IfNDeC90C7rVw_RCJr69VOQP9QxsecX2IW6k/edit?usp=sharing
...
The project follows a **Layered Architecture** (Controller → Service → Repository) to separate concerns:
...
* **Current Approach:** Fetch Product → Validate Stock → Save New Value.
...
👉 **View Docs:** [http://localhost:3000/api-docs](http://localhost:3000/api-docs)
